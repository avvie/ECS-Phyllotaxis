...
public class RotationSpeedSystem : ComponentSystem {
	...
	struct RotationSpeedRotation : IJobParallelFor{
		...
		public void Execute(int i){
            ...
            m.m0.x = 1.0f - (yy + zz); m.m1.x = xy + wz; m.m2.x = xz - wy; m.m3.x = position[i].Value.x;
            m.m0.y = xy - wz; m.m1.y = 1.0f - (xx + zz); m.m2.y = yz + wx; m.m3.y = position[i].Value.y;
            m.m0.z = xz + wy; m.m1.z = yz - wx; m.m2.z = 1.0f - (xx + yy); m.m3.z = position[i].Value.z;
	...
	protected override void OnUpdate(){
		...
		// }
		// Debug.Log(Bootstrap.entityManager.GetComponentData<TransformMatrix>(Bootstrap.transform).Value.m0.x);
